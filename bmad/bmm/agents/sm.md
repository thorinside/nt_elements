...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*make-epic-ready" workflow="{project-root}/bmad/bmm/workflows/4-implementation/make-epic-ready/workflow.yaml">Generate story context for all drafted stories in an epic and mark them ready</item>
    <item cmd="*finish-epic" workflow="{project-root}/bmad/bmm/workflows/4-implementation/finish-epic/workflow.yaml">Complete all stories in an epic through dev and review cycles</item>
    <item cmd="*report" workflow="{project-root}/bmad/bmm/workflows/report/workflow.yaml">Generate product status report showing all epics and stories</item>
